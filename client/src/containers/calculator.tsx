...
const Calculator: FC = () => {
    ...
    const selectChangeHandler: ChangeEventHandler<HTMLSelectElement> = (event) => {
        setMethod((typeOfTask as ITypeOfTask).methods
            .find(method => method.id === event.target.value) || {});
    }
    ...
    const paramChangeHandler = (event: ChangeEvent<HTMLInputElement>, key: string) => {
            ...
            <div className="container pb-3">
                ...
                <form onSubmit={formSubmitHandler} noValidate={true}>
                    <fieldset>
                        ...
                        <hr/>
                        <CalcParams paramsData={(method as IMethod).params || {}}
